USE DBAtools
GO
/****** Object:  StoredProcedure [dbo].[sp_who3]    Script Date: 26-8-2015 14:54:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

IF OBJECT_ID('dbo.sp_who3') IS NULL
  EXEC ('CREATE PROCEDURE dbo.sp_who3 AS RETURN 0;')
GO

IF OBJECT_ID('dbo.sp_blocked') IS NULL
  EXEC ('CREATE PROCEDURE dbo.sp_blocked AS RETURN 0;')
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_blocked]    Script Date: 26-8-2015 14:56:19 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
ALTER procedure [dbo].[sp_blocked]
@spid int
as
